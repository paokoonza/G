...
cl = LINETCR.LINE()
cl.login(token="EvU0ywOw98P0BwN1lhB2.E2+ns5ujaS28aaX5qt1OKG.zro/ycH1af9n6V0OXKT1shLWpli8vMEi857flnsqNPg=")
cl.loginResult()
...
helpmsg ="""  ⭐MIN HACK BOT TEAM NOXTYPE⭐
─┅═⭐s̵ᴇʟғʙᴏᴛ ᴛʜᴀɪʟᴀɴᴅ⭐═┅─
╔══════════╗
╠🐯 คำสั่งสำหรับบอท⭐
╠🐯ภาษาไทย⭐
...
helpset =""" ⭐MIN HACK BOT TEAM NOXTYPE⭐
👉Gname: -ตั้งชื่อกลุ่ม
👉Kick: -สั่งเตะด้วยMid
...
helptranslate ="""⭐MIN HACK BOT TEAM NOXTYPE⭐\n\n
⭐Hhx0; ไส่ข้อความแอด
...
Bots =["u7b6fcd4b950902cdbc000c79413d6892",mid]
admin=["u7b6fcd4b950902cdbc000c79413d6892",mid]
Creator= "u7b6fcd4b950902cdbc000c79413d6892"
...
#                            Name = summon(op.param2)
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                cl.sendText(msg.to,"⭐SELF BOT BYMIN")
        ...
        if op.type == 25:
            ...
            elif msg.text in ["อั.ฟข้อมูล","Upl.oad"]:
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                if wait["Contact"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"⭐ทำงานอยู่แล้ว⭐")
                else:
                    wait["Contact"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐เปิดระบงอ่านคอนแทค⭐")
                    else:
                        cl.sendText(msg.to,"⭐เรียบร้อยแล้ว⭐")
                ...
                if wait["Contact"] == False:
                    ...
                    wait["Contact"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐หยุดการทำงานแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐ระบงถูกปิด⭐")
            elif msg.text.lower() == 'เปิดป้องกัน':
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐เปิดระบบป้องกันแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐ถูกเปิดแล้ว⭐")
                else:
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐เปิดระบบป้องกันแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐เปิดระบบแล้ว⭐")
            elif msg.text.lower() == 'กันลิงค์':
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ห้ามข้อลิ้งนอกจากแอดมิน ป้องกันQr เปิดแล้ว⭐")
                    else:
                ...
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ห้ามเชิญคนอืนนอกจากแอดมิน เปิดแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐เปิดแล้ว⭐")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"⭐ระบบทำงานแล้ว⭐")
            elif msg.text.lower() == 'กันยก':
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ป้องกันการยกเชิญ เปิด⭐")
                    else:
	     ...
	     if msg.from_ in admin:	 	        
		     wait["AutoKick"] = True
		     cl.sendText(msg.to,"⭐ป้องกันเปิด autokick⭐")
	     else:
	        cl.sendText(msg.to,"⭐เปิดแล้ว⭐")	     
	     ...
	     if msg.from_ in admin:	 	        
	        ...
	        cl.sendText(msg.to,"⭐ปิดระบบแล้ว⭐")
            elif msg.text.lower() == 'เปิดเข้า':
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐เปิดออโต้การเข้ารวมกลุ่มอัตโนมัต⭐")
                    else:
                        cl.sendText(msg.to,"⭐เปิดแล้ว⭐")
                else:
                    wait["autoJoin"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ทำงานแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐ทำงานเต็มที่แล้ว⭐")
            elif msg.text.lower() == 'ปิดเข้า':
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ปิดการเข้าร่วมกลุ่มอัตโนมัต ถูกปิดแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐ปิดแล้ว⭐")
                else:
                    wait["autoJoin"] = False
                ...
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ปิดป้องกันแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐ปิดเรียบร้อย⭐")
                else:
                    wait["protect"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ปิดระบบ Off⭐")
                    else:
                        cl.sendText(msg.to,"⭐ไม่ทำงานแล้ว⭐")
            elif msg.text.lower() == 'ปิดกันลิงค์':
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ปิดป้องกัน QR แล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐เรียบร้อย⭐")
                else:
                    wait["linkprotect"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐หยุดการทำงาน⭐")
                    else:
                        cl.sendText(msg.to,"⭐ปิดการทำงานเสร้จสิ้น⭐")
            elif msg.text.lower() == 'ปิดกันเชิญ':
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ปิดป้องกันการเชิญแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐ปิดป้องกันการเชิญแล้ว⭐")
                else:
                ...
                if wait["cancelprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ปิดป้องกันการยกเชิญแล้ว⭐")
                    else:
                        cl.sendText(msg.to,"⭐ปิดป้องกันการยกเชิญแล้ว⭐")
                else:
...
#======================================================#
            elif msg.text in ["Min on","All on"]:
                        cl.sendText(msg.to,"⭐⭐")
...
#======================================================#
            elif msg.text in ["Min off","All off"]:
                        cl.sendText(msg.to,"⭐⭐")
...
#======================================================#
                ...
                if wait["contact"] == True: md+="╠⭐➣􏿿 Contact:on\n"
                else:md+="╠⭐➣􏿿 Contact:off\n"
                if wait["autoJoin"] == True: md+="╠⭐➣􏿿 Auto Join:on \n"
                else:md+="╠⭐➣􏿿 Auto Join:off \n"
                if wait["autoCancel"] == True: md+="╠⭐➣􏿿 Auto cancel:" + str(wait["autoCancel"]["members"]) +" \n"
                else:md+="╠⭐➣􏿿 Group cancel:off\n"
                if wait["AutoCancel"] == True: md+="􀜁╠⭐➣ auto cancel:on \n"
                else:md+="╠⭐➣􏿿 auto cancel:off\n"
                if wait["leaveRoom"] == True: md+="╠⭐➣􏿿 Auto leave:on \n"
                else:md+="╠⭐➣􏿿 Auto leave:off \n"
                if wait["timeline"] == True: md+="╠⭐➣􏿿 Share:on 􀜁􀄯\n"
                else:md+="╠⭐➣􏿿 Share:off\n"
                if wait["autoAdd"] == True: md+="╠⭐➣􏿿 Auto add:on  \n "
                else:md+="╠⭐➣􏿿 Auto add:off \n"
                if wait["protect"] == True: md+="╠⭐➣􏿿 Protect:on \n"
                else:md+="╠⭐➣􏿿 Protect:off\n"
                if wait["linkprotect"] == True: md+="╠⭐➣􏿿 Link Protect:on \n"
                else:md+="╠⭐➣􏿿 Link Protect:off \n"
                if wait["inviteprotect"] == True: md+="╠⭐➣􏿿 Invitation Protect:on\n"
                else:md+="╠⭐➣􏿿 Invitation Protect:off \n"
                if wait["cancelprotect"] == True: md+="╠⭐➣􏿿 Cancel Protect:off 􀜁􀄰 \n"
                else:md+="╠⭐➣􏿿 Cancel Protect:off\n"
                if wait["commentOn"] == True: md+="╠⭐➣􏿿 Auto komentar:on\n"
                else:md+="╠⭐➣􏿿Auto komentar:off\n"
                if wait["sticker"] == True: md+="╠⭐➣􏿿 Sticker:on\n"
                else:md+="╠⭐➣􏿿Sticker:off\n"
                if wait["AutoKick"] == True: md+="╠⭐➣􏿿 Auto kick:on \n"
                else:md+="╠⭐➣􏿿Auto kick:off\n"
                if wait["Sambutan"] == True: md+="╠⭐➣􏿿 sambutan:on \n "
                else:md+="╠⭐➣􏿿 sambutan:off\n"
                if wait["Tagvirus"] == True: md+="╠⭐➣􏿿 tagvirus:on \n"
                else:md+="╠⭐➣􏿿 tagvirus:off\n"
                if wait["kickMention"] == True: md+="╠⭐➣􏿿 KickMention:on \n"
                else:md+="╠⭐➣􏿿 KickMention:off\n"
                if wait["autoBlock"] == True: md+="╠⭐➣􏿿 AutoBlock:on \n"
                else:md+="╠⭐➣􏿿 AutoBlock:off\n"
                if wait["detectMention"] == True: md+="╠⭐➣􏿿 Respon1:on \n"
                else:md+="╠⭐➣􏿿 Respon1:off \n"
                if wait["detectMention2"] == True: md+="╠⭐➣􏿿 Respon2:on \n"
                else:md+="╠⭐➣􏿿 Respon2:off \n"
                if wait["detectMention3"] == True: md+="╠⭐➣􏿿 Respon3:on \n"
                else:md+="╠⭐➣􏿿 Respon3:off \n╚═┈━═✥มิน✥═━┈═╝"
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    msg.contentMetadata = {'mid': target}
            elif cms(msg.text,["Teston"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': "⭐SELFMINHACKBOT⭐"}
                cl.sendMessage(msg)
                cl.sendMessage(msg)
            elif msg.text.lower() == 'เปิดแอด':
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐เปิดออโต้แอด⭐")
                    else:
                        cl.sendText(msg.to,"⭐เปิดออโต้แอด⭐")
                else:
                    wait["autoAdd"] = True
                ...
                if wait["autoAdd"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐ปิดออโต้แอด⭐")
                    else:
                        cl.sendText(msg.to,"⭐ปิดออโต้แอด⭐")
                else:
                    wait["autoAdd"] = False
                ...
                if wait["autoBlock"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"⭐ระบบออโต้บล็อค\nปิดใช้งานอยุ่แล้ว⭐")
            elif "Hhx0: " in msg.text:
                wait["message"] = msg.text.replace("Hhx0: ","")
                cl.sendText(msg.to,"⭐เชิญทำการเปลี่ยนแปลงข้อความคนแอด⭐" + wait["message"])
            elif msg.text.lower() == 'Hhx0':
                if wait["lang"] == "JP":
                ...
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"⭐เปลี่ยนการตั้งค่าคอมเม้นของคุณแล้ว ดังนี้⭐" + wait["comment"])
                else:
                    wait["comment"] = c
                    cl.sendText(msg.to,"⭐เปลี่ยนการตั้งค่าคอมเม้นของคุณแล้ว⭐ \n  ดังนี้\n" + c)
            elif msg.text in ["Hhx4 on","เปิดเม้น","Comment on"]:
                if wait["commentOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"⭐คอมเม้นออน⭐")
                    else:
                        cl.sendText(msg.to,"⭐open⭐")
                else:
                    wait["commentOn"] = True
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["Hhx4 off","ปิดเม้น"]:
...
#================================  STARTED ==============================================#
            ...
            elif "ไลน์: " in msg.text:
                msgg = msg.text.replace('ไลน์: ','')
